...
{Fore.GREEN}[*] Production Ready WiFi Security Assessment Tool
[*] No Mock - Full Real WiFi Capabilities
[*] Enhanced with Advanced Attack Vectors{Style.RESET_ALL}
{Fore.RED}[!] Use responsibly and only on networks you own or have permission to test{Style.RESET_ALL}
"""
        print(banner)
